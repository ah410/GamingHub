        ...
        <nav className="bg-primary flex justify-center items-center w-screen">
            {session && 
                <ul className="flex justify-between w-full">
                    ...
                    <div className="flex items-center justify-center mr-3 py-2">
                        <li>
                        ...
                        <li>
                            <button className="flex items-center justify-center outline outline-accent hover:bg-accent hover:outline-none transition-colors duration-200 rounded-lg px-3 py-2 mr-2" onClick={logout}>
